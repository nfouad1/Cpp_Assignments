...
void RecordForCarService::getinput() {
        ...
        string fname;
            ...
            cin >> records;
        //    int NrOfRecords = new int[records];
            RecordForCarService RecordArray[records];
            for (int i = 0; i < records; i++){
               ...
               // setServiceParts(serviceparts[i]);
                cout << endl;
                cout << "Payment method:  1. Cash or 2. Creditcard: "; cin >> pMethod; setPayment(pMethod);
                cout << endl;
            }
...
int main (){
    ...
    while (true){     
        ...
        cout <<"1. Enter service records. \n"<< "2. Se details of the records. \n"<< "3. Exit the program."<< endl;
        cin >> choice;
        if (choice == 1){
                service.getinput();
