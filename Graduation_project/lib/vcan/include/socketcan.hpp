...
#ifndef SOCKETCAN_HPP  // NOLINT
#define SOCKETCAN_HPP  // NOLINT
...
class SocketCan {
    public:
        ...
        SocketCanStatus open(const std::string & can_interface,
        int32_t read_timeout_ms = 3, SocketMode mode = MODE_CAN_MTU);
